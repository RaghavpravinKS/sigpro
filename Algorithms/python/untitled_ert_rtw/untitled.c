 ...
 * C/C++ source code generated on : Sat Sep 30 14:55:22 2023
 *
 ...
 */
void untitled_MATLABFunction1(const uint8_T rtu_u[307200], uint8_T rty_y[307200])
{
  memcpy(&rty_y[0], &rtu_u[0], 307200U * sizeof(uint8_T));
}
...
void untitled_step(void)
{
  ...
  TCPStreamStepSend(&untitled_B.y_f[0], 307200U, untitled_DW.obj_m.connStream_,
  ...
  TCPStreamStepSend(&untitled_B.b_varargout_3[0], 307200U,
  ...
  TCPStreamStepSend(&untitled_B.y_f[0], 307200U, untitled_DW.obj.connStream_,
...
void untitled_initialize(void)
{
  ...
  INITIALIZE_CAMERA(1.0, 2, 640, 480);
