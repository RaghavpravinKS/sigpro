...
typedef struct {
  ...
  uint8_T y_f[307200];                 /* '<Root>/MATLAB Function3' */
  real32_T outData[80];
} B_untitled_T;
...
typedef struct {
  ...
  codertarget_internal_androidT_T obj_m;/* '<Root>/TCP//IP Send' */
 ...
 * '<S4>'   : 'untitled/MATLAB Function2'
 * '<S5>'   : 'untitled/MATLAB Function3'
 */
