...
void sample_model_2_step(void)
{
  ...
  /* Call plotting routine for a mobile target */
  {
...

    {
      ...
      real32_T up0[1];
      up0[0] = (real32_T)sample_model_2_B.b_scale;
  ...
  /* Call plotting routine for a mobile target */
  {
...

    {
      ...
      real32_T up0[1];
      up0[0] = (real32_T)sample_model_2_B.qm;
...
void sample_model_2_initialize(void)
{
  ...
  /* SetupRuntimeResources for Scope: '<Root>/Scope1' */
  {
    const char* mobileScopeProperties2 =
      "{\"axesColor\":[0,0,0],\"axesScaling\":\"manual\",\"axesTickColor\":[0.6862745098039216,0.6862745098039216,0.6862745098039216],\"blockType\":\"Scope\",\"displays\":[{\"lineColors\":[[1,1,0.06666666666666667],[0.07450980392156863,0.6235294117647059,1],[1,0.4117647058823529,0.1607843137254902],[0.39215686274509803,0.8313725490196079,0.07450980392156863],[0.7176470588235294,0.27450980392156865,1],[0.058823529411764705,1,1],[1,0.07450980392156863,0.6509803921568628]],\"lineStyles\":[\"-\",\"-\",\"-\",\"-\",\"-\",\"-\",\"-\"],\"lineWidths\":[0.75,0.75,0.75,0.75,0.75,0.75,0.75],\"showGrid\":true,\"showLegend\":false,\"yLimits\":[-7.09743,36.34223]}],\"frameBasedProcessing\":false,\"inputNames\":[\"MATLAB Function1\\/pitch\"],\"layoutDimensions\":[1,1],\"timeSpan\":20,\"timeSpanOverrunMode\":\"Wrap\"}";
    int_T numInputPortsScope2 = 1;
    int_T scope2ID = 2;
    real32_T sampleTimes2[1] = { 0.5 };
  ...
  /* SetupRuntimeResources for Scope: '<Root>/Scope2' */
  {
    const char* mobileScopeProperties3 =
      "{\"axesColor\":[0,0,0],\"axesScaling\":\"manual\",\"axesTickColor\":[0.6862745098039216,0.6862745098039216,0.6862745098039216],\"blockType\":\"Scope\",\"displays\":[{\"lineColors\":[[1,1,0.06666666666666667],[0.07450980392156863,0.6235294117647059,1],[1,0.4117647058823529,0.1607843137254902],[0.39215686274509803,0.8313725490196079,0.07450980392156863],[0.7176470588235294,0.27450980392156865,1],[0.058823529411764705,1,1],[1,0.07450980392156863,0.6509803921568628]],\"lineStyles\":[\"-\",\"-\",\"-\",\"-\",\"-\",\"-\",\"-\"],\"lineWidths\":[0.75,0.75,0.75,0.75,0.75,0.75,0.75],\"showGrid\":true,\"showLegend\":false,\"yLimits\":[-250.1675,27.91779]}],\"frameBasedProcessing\":false,\"inputNames\":[\"MATLAB Function1\\/yaw\"],\"layoutDimensions\":[1,1],\"timeSpan\":20,\"timeSpanOverrunMode\":\"Wrap\"}";
    int_T numInputPortsScope3 = 1;
    int_T scope3ID = 3;
    real32_T sampleTimes3[1] = { 0.5 };
