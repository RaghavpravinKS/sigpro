package com.example.audio_sine_wave;
...
import com.example.audio_sine_wave.databinding.ActivityMainBinding;
...
public class audio_sine_wave extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.audio_sine_wave.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private audio_sine_wave thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","audio_sine_wave"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("audio_sine_wave.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    ...
    private native int naMain(String[] argv, audio_sine_wave pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("audio_sine_wave");
    }
