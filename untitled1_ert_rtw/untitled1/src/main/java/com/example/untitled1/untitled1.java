...
import com.example.untitled1.databinding.ActivityMainBinding;
...
public class untitled1 extends AppCompatActivity implements OnFragmentInteractionListener , CvCameraViewListener2 {
 ...
 // properties specific for Camera block
   ...
   private boolean isCamera2Supported() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.untitled1.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
...
mSendBlockNames = getResources().getStringArray(R.array.tcpSendBlockNames);
    ...
    private untitled1 thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","untitled1"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("untitled1.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    ...
    private native int naMain(String[] argv, untitled1 pThis);
